...
- **グランプリモード (NEW!)**: 全5ラウンドを勝ち抜くローグライク形式のゲームモード。レースごとの強化（レリック）システム搭載。
...
### 🏆 グランプリモード (Grand Prix Mode)
ローグライク要素を取り入れた、連続5レースの勝ち抜きモードです。

1. **モード切替**: 画面下の「GP MODE: OFF」ボタンをクリックして **ON** にします。
2. **スタート**: 馬を選んで「START GP!」ボタンで開始します。
3. **予選突破**: 3着以内に入ると次のラウンドへ進めます（4着以下は脱落）。
4. **強化**: レース終了後、3つのランダムな「レリック（アイテム）」から1つを選んで馬を強化できます。
    - 🥕 **Golden Carrot**: 基本速度アップ
    - 🍀 **Lucky Horseshoe**: スキル発動率アップ
    - 🥽 **Hydro Goggles**: 雨の影響を無視
    - ...など
5. **戦略**: 次のレースの天気やコース予報を見て、最適なアイテムを選びましょう！
6. **完全制覇**: 5ラウンドを勝ち抜き、グランプリチャンピオンを目指せ！
